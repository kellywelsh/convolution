# -*- coding: utf-8 -*-
"""
Created on Wed May  8 08:58:09 2019
...
#load_dataset() pero mnist para ejemplo con mnist
...
X_train = X_train_orig[...,np.newaxis]/255. #nuevo eje de un espacio
...
def create_placeholders(n_H0, n_W0, n_C0, n_y):
    ...
    N=numero de ejemplos, batch=partimos en lotes el entrenamiento
    """
...
def initialize_parameters():
    ...
    [4, 4, 3, 8]: 4,4 es el tamaño del filtro, para encontrar bordes más pronunciados
    3, los canales de entrada
    8, numero de filtros que se van a aplicar, por cada filtro se genera un conjunto de pesos
    [2, 2, 8, 16] 8= porque la capa anterior terminó con 8 de profundidad, y este debe tener el mismo con el que terminó
    16= aplicar 16 filtros
    """
...
def forward_propagation(X, parameters):
    ...
    [1,H,W,1]=a los ejemplos no se les aplica stride, el filtro se aplica a todos los canales por eso el 1,1
    padding='VALID' es padding = 0
    padding='SAME' calcula el padding para que no se afecte la resolución
    """
    ...
    #Z1 es la parte lineal de la neurona
    Z1 = tf.nn.conv2d(X, W1, strides = [1,1,1,1], padding = 'SAME')
    
    # RELU
    #reslu es maximo entre 0 y Z, es para la parte no lineal
    A1 = tf.nn.relu(Z1)
    
    # MAXPOOL: window 8x8, stride 8, padding 'SAME'
    #esto es para reducir la resolución espacial
    #strides es igual al tamaño del filtro "8x8"
...
def model(X_train, Y_train, X_test, Y_test, learning_rate = 0.009, num_epochs = 3, minibatch_size = 16, print_cost = True):
    """
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, "saved_model\model_softmax1.ckpt")
